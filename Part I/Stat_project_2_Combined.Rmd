...
Model assumptions were examined by plotting residual vs fitted and qq-plot. As above, the model does not satisify the normality assumption. There appears to be clustering in the residual plot, because the model cannot distinguish mature vs inmature rats, while also the variances are not very constant for the clusters. 

**Need to say if linearity and equal variance are violated or not**
