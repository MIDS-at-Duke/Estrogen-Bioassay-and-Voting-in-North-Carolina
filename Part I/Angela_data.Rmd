...
From taking a quick look to the data set, We noticed that there are 4 rows missing uterus weight values and 2 of them even missing weight values. Since these missing rows are occured rondomly,which means these rows are in different group, protocol type, and lab. Therefore, we decided to delete these four rows.
