...
par(mfrow=c(1,4)) 
hist(estrogen$uterus, col = rainbow(15))
hist(log(estrogen$uterus), col = rainbow(15))
#This one looks the best compared to the other transformations, use this for analysis
hist(sqrt(estrogen$uterus), col = rainbow(15))
hist((estrogen$uterus)^(1/3), col = rainbow(15))
```
