...
Model_1 <- glm(cbind(total_voters, voted_voters)~ county_desc + party_cd + age + race_code +
                ethnic_code + sex_code, data = Votes_Dataset, family = binomial)
...
Model_3 <- glmer(cbind(total_voters, voted_voters) ~ (1+age|county_desc) + 
                party_cd + age + race_code + ethnic_code + sex_code,
                 data = Votes_Dataset, family = binomial)
...
```
```{r}
Model_4 <- glmer(cbind(total_voters, voted_voters) ~ (1|county_desc) + 
                party_cd + age + race_code + ethnic_code + sex_code + age:party_cd 
                + sex_code:party_cd,
                 data = Votes_Dataset, family = binomial)
